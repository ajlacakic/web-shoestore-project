...
if (!window.productList22) {
    var productList22 = document.getElementById('productList22');
}

if (productList22) {
    productList22.innerHTML = ''; 
}


$.ajax({
    url: 'php/load_womenshoes.php',
    type: 'GET',
    dataType: 'json',
    headers: {
        'Authorization': token 
    ...
    success: function(data) {
        data.shoes.forEach(shoe => {
            ...
            `;
            productList.appendChild(shoeDiv);
        });
